      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative overflow-x-hidden lg:overflow-x-visible">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-green-500 text-white px-6 py-3 rounded-2xl shadow-xl shadow-green-500/30 flex items-center gap-3 w-max max-w-[90vw]">
